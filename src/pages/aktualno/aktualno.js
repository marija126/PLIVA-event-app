 ...
 */
var AktualnoPage = /** @class */ (function () {
    function AktualnoPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    AktualnoPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad AktualnoPage');
    };
    AktualnoPage.prototype.goToCreateAkutalno = function () {
        this.navCtrl.push('DodajAktualnoPage');
    };
    AktualnoPage = __decorate([
        IonicPage(),
        Component({
